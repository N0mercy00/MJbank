    ...
    <center><br><br><br>
        ...
        ?>
            <form action="withdraw_action.php" method="POST">
                <p>*출금 계좌 : &nbsp;<input type="number" name="a_id" min="0" required="required"></p>
                <p>*출금 금액 : &nbsp;<input type="number" name="amount" min="0" required="required"></p>
                <p style="text-align:center;"><input type="submit" value="출금하기"></p>
            </form>
