    ...
    <center><br><br><br>
        ...
        ?>
            <form action="transfer_action.php" method="POST">
                <p>*출금 계좌 : &nbsp;<input type="number" name="sa_id" min="0" required="required"></p>
                <p>*이체 계좌 : &nbsp;<input type="number" name="ra_id" min="0" required="required"></p>
                <p>*이체 금액 : &nbsp;<input type="number" name="amount" min="0" required="required"></p>
                <p style="text-align:center;"><input type="submit" value="이체하기"></p>
            </form>
